  ...
  <body>
    <?php
      ...
      if(isset($_POST["save"])){
        ...
        {
          $result= "Registration successfull &nbsp; <i class='fas fa-check-square'></i>";
    ...
    >
     ...
     <div class="box">
      ...
      <input type="checkbox" onclick="myFunction()" id="spass" /> Show password
      ...
      <br />
      <button style="height:30px;width:150px;margin-left:145px;" id="save" name="save">Submit </button>
    </form>
